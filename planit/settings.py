...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-+^o*71f8504b2)o50=khalnm=3$2251%2c)unhc+l0so!ou3(e')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'ambiente.context_processors.invitations_processor',
                'ambiente.context_processors.notificacoes_processor',
            ],
        },
    },
]
